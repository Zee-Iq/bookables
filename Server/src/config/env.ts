...
function parseEnv(env: NodeJS.ProcessEnv): Env {
  ...
  if (typeof env.URL_PRODUCTION !== "string") throw new Error("env.URL_PRODUCTION is missing");

  if (typeof env.URL_DEV !== "string") throw new Error("env.URL_DEV is missing");
